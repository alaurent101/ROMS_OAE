...
#endif
#if defined SOC_HRM23 || defined SOC_H2
!
...
# elif defined PCO2AIR_SABLEISLAND
      ...
      real(r8), parameter :: D2 = 4.0601_r8               ! secular trend in
      real(r8), parameter :: D3 =-0.5814_r8               ! atmospheric pCO2
...
!-----------------------------------------------------------------------
!
#if defined  WOC_HRM23 || defined WOC_H2
...
!
               ...
               Bio(i,k,iTAlk)=Bio(i,k,iTAlk)+cff4*Bio(i,k,iParticle1)
# ifdef TALK_TRACERS
               Bio(i,k,iTArm)=Bio(i,k,iTArm)+cff4*Bio(i,k,iParticle1)
# endif
!
!-----------------------------------------------------------------------
...
!
     ...
     &          .and. k.eq.kloc_alkalinity(ng)) THEN
# ifdef TALK_FILE
