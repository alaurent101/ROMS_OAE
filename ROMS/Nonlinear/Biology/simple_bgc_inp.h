...
# endif
            ...
            CASE ('kloc_alkalinity')
              Npts=load_r(Nval, Rval, Ngrids, kloc_alkalinity)
...
# endif
     ...
     &            'latitude (j) index for alkalinity addition'
           WRITE (out,80) kloc_alkalinity(ng), 'kloc_alkalinity',       &
     &            'vertical (k) index for alkalinity addition'
...
!
  ...
  60  FORMAT (/,/,' Simple BGC Model Parameters, Grid: ',i2.2,              &
     &        /,  ' =================================',/)
