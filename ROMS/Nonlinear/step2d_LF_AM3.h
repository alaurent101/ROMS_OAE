...
! Modified to allow use of addition to SSH when Ji et al. (2012) river
! scheme is used 2021/4/22
!
...
# ifdef NUDGE_BDRY
! Added nudging towards reanalysis 2021/9/25
...
!-----------------------------------------------------------------------
!
!  Added check for Ji et al. river scheme 2021/2/14
#if !defined RIVER_JI
      IF (LuvSrc(ng)) THEN
        DO is=1,Nsrc(ng)
          i=SOURCES(ng)%Isrc(is)
