...
*******************************************************************************
**
** Options for no-input run using 1/12-deg grid 
**
** Application flag:   P_202101_01
** Input script:       roms_p_202101_01.in
*/
...
#  define ALBEDO_CLOUD
# endif
# undef ATM_PRESS /* impose atmospheric sea-level pressure onto sea surface */
# undef SHORTWAVE /* shortwave radiation */
# undef CLOUDS /* define cloud fraction */
/* Added 2020/3/6 */
# undef COOL_SKIN /* cool skin correction */

/* Added 2016/9/16 */
# undef SSH_TIDES /* impose tidal elevation */
# undef UV_TIDES /* impose tidal currents */
# undef RAMP_TIDES /* ramp tidal forcing from zero over one day */
